...
fun HomeScreen(
   ...
   LazyColumn(
       ...
       item {
           Header()
           CustomTextField(text = text, modifier = Modifier, onValueChange = {text = it})
              // custom textfeildpadding + spacer height padding = 40.dp
           SpacerHeight(20.dp)
           CategoryRow( )
           SpacerHeight(20.dp)
           PopularRow {
 ...
 onClick: () -> Unit
    ...
    Column {
        ...
        FlowRow(
            ...
            horizontalArrangement = Arrangement.SpaceEvenly // becuase of this we don't need to provide padding
        ) {
...
fun PopularEachRow(
    ...
    Column(
        ...
        SpacerHeight()
        ElevatedCard(
            modifier = Modifier.align(CenterHorizontally) // it will align itself acc to parent which is column here
        ) {  // and note flow row gives fill max width
...
fun CategoryEachRow(
    ...
    Box(
        modifier = Modifier
            .padding(end = 15.dp)  //  from start it consider lazycolumn width
        ...
        Image(
            ...
            modifier = Modifier
                .size(60.dp)
                .padding(end = 5.dp)
                .align(BottomEnd) // what is the use of that
        )
    ...
    Row(
        ...
        IconButton(onClick = onclick,
            ...
            Icon(
                ...
                contentDescription = "",
                tint =  Color.Unspecified // default color by system is color.unspecified
