...
fun ProductDetailScreen(
    ...
    var selected by remember { mutableStateOf(0) }  // by default description is selected
    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        Image(
           ...
           modifier = Modifier
               .fillMaxWidth()  // what is the use of these properties ?
               .height(250.dp),
        ...
        Box(
            ...
            LazyColumn(modifier = Modifier.padding(bottom = 70.dp)) {  // what is the use of this padding
                item {
                ...
                Row {
                       chips.forEachIndexed { index, s ->
                           CustomChips(
                               ...
                               index = index,
                               onValueChange = {
                                   selected = it  // passing index value
                                })
                    }
                   }
                    SpacerHeight()
...
fun CustomChips(
    title: String,
    selected: Boolean,  // har ek ke liye alag boolean
    index: Int,
    modifier: Modifier = Modifier,
    ...
    TextButton(
        ...
        colors = ButtonDefaults.buttonColors(
            ...
            contentColor = if (selected) DarkOrange else LightGray_1   // changes color?
        ),
        elevation = ButtonDefaults.buttonElevation(0.dp),
...
fun RatingRow() {
    ...
    val personIcons = listOf(
        R.drawable.person_1, // resource id different from index defined by R class generated by android built system
        R.drawable.person_2,
        R.drawable.person_3,
        R.drawable.person_4
    )
...
fun HeaderSection(
    ...
    Row(
        ...
        TextButton(
            onClick = { navHostController.navigate(Checkout)} ,
